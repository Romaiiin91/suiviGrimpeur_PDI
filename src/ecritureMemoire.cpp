 ...
 * Description : Programme to write video frames into shared memory.
 * Author      : Romain
 * Date        : 16/03/2025
 * Version     : 1.0
 *
 * This programme captures video frames from a given source and writes them
 * into shared memory for inter-process communication. It uses semaphores
 * for synchronisation and signal handling for graceful termination.
 *
 ...
 *
 * Notes       : 
 * - The programme uses OpenCV for video capture and processing.
